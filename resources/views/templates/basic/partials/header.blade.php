        ...
        <div class="header_inner mcontainer">
            <div class="left_side">
                ...
                <div id="logo">
                    <a href="{{ route('user.home') }}">
                        <img src="{{ asset($general->website_logo) }}" alt="{{ $general->website_name }}">
                        <img src="{{ asset($general->website_logo) }}" class="logo_mobile" alt="{{ $general->website_name }}">
                    </a>
                </div>
            </div>

            <!-- search icon for mobile -->
            @livewire($activeTemplate . 'search')
            ...
            <div class="right_side">
                ...
                <div class="header_widgets">
                    ...
                    <div uk-drop="mode: click" class="header_dropdown dropdown_cart">
                        ...
                        <div class="cart_footer">
                            ...
                            <h1> Total :  <strong> $ 320</strong> </h1>
                                 ...
                                 @livewire('templates.basic.notifications')
                    ...
                    <a href="#">
                        <img src="{{ asset(Auth::user()->avtar) }}" class="is_avatar" alt="{{ Auth::user()->firstname . ' ' . Auth::user()->lastname }}">
                    </a>
                    <div uk-drop="mode: click;offset:5" class="header_dropdown profile_dropdown">

                        <a href="timeline.html" class="user">
                            <div class="user_avatar">
                                <img src="{{ asset(Auth::user()->avtar) }}" alt="{{ Auth::user()->firstname . ' ' . Auth::user()->lastname }}">
                            </div>
                            <div class="user_name">
                        ...
                        <hr>
                        <a href="{{ route('user.setting.generalSetting') }}">
