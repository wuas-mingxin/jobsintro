...
<div class="login-main"
    style="background-image: url('{{ asset('wuas-admin/images/login.jpg') }}')">
                ...
                <div class="login-area">
                    <div class="login-wrapper">
                        ...
                        <div class="login-wrapper__body">
                            <form action="{{ route('admin.login.submit') }}" method="POST" class="cmn-form mt-30 verify-gcaptcha login-form">
                                @csrf
