...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->enum('e_like', ['0','1'])->default(1);
            $table->enum('e_wondered', ['0','1'])->default(1);
            $table->enum('e_shared', ['0','1'])->default(1);
            $table->enum('e_followed', ['0','1'])->default(1);
            $table->enum('e_commented', ['0','1'])->default(1);
            $table->enum('e_visited', ['0','1'])->default(1);
            $table->enum('e_liked_page', ['0','1'])->default(1);
            $table->enum('e_mentioned', ['0','1'])->default(1);
            $table->enum('e_joined_group', ['0','1'])->default(1);
            $table->enum('e_accepted', ['0','1'])->default(1);
            $table->enum('e_profile_wall_post', ['0','1'])->default(1);
